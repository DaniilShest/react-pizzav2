    ...
    return (
        items.length
                ...
                <div className="cart__head">
                    <div className="cart__title">
                        <svg width="30" height="30" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.33333 16.3333C7.06971 16.3333 7.66667 15.7364 7.66667 15C7.66667 14.2636 7.06971 13.6667 6.33333 13.6667C5.59695 13.6667 5 14.2636 5 15C5 15.7364 5.59695 16.3333 6.33333 16.3333Z" stroke="#2C2C2C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M14.3333 16.3333C15.0697 16.3333 15.6667 15.7364 15.6667 15C15.6667 14.2636 15.0697 13.6667 14.3333 13.6667C13.597 13.6667 13 14.2636 13 15C13 15.7364 13.597 16.3333 14.3333 16.3333Z" stroke="#2C2C2C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M4.78002 4.99999H16.3334L15.2134 10.5933C15.1524 10.9003 14.9854 11.176 14.7417 11.3722C14.4979 11.5684 14.1929 11.6727 13.88 11.6667H6.83335C6.50781 11.6694 6.1925 11.553 5.94689 11.3393C5.70128 11.1256 5.54233 10.8295 5.50002 10.5067L4.48669 2.82666C4.44466 2.50615 4.28764 2.21182 4.04482 1.99844C3.80201 1.78505 3.48994 1.66715 3.16669 1.66666H1.66669" stroke="#2C2C2C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                        <h1>Корзина</h1>
                    </div>
                    <div className="clear__cart" onClick={() => dispatch(clearItems())}>
                        ...
                        <p className="clear__text">Очистить корзину</p>
                    </div>
                </div>
                <div className="line"></div>
                <div className="cart__items">
                    {items.map(item => (
                        <CartItem item={item} key={item.id + item.type + item.size} />
                    ))}
                </div>
                <div className="cart__bottom">
                    <div className="cart__info">
                        <div className="cart__count">Всего пицц: <b>{count} шт.</b></div>
                        <div className="cart__price">Сумма заказа: <span>{totalPrice} ₽</span></div>
                    </div>
                    <div className="cart__btns">
                        <Link to="/" className="cart__back">Вернуться назад</Link>
                        <a className="cart__order" href="">Оформить заказ</a>
                    </div>
                </div>
            </div>
            :
            <div className="cart-empty">
                ...
                <p className="cart-empty__text">Вероятней всего, вы ещё не заказывали пиццу.
                ...
                <svg width="300" height="255" viewBox="0 0 300 255" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M197.278 173.629L156.709 91.0457C155.471 90.3018 150.502 87.0103 150.502 87.0103" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M153.799 97.5847C153.314 95.933 151.86 92.5295 151.86 92.5295C150.972 92.4735 144.789 89.194 144.789 89.194" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M143.02 89.498L162.244 81.4112" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <path d="M294.845 204.792H168.113V176.44C175.044 175.808 273.577 166.21 273.577 166.21V104.568L153.799 97.5847L168.113 176.448" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
                    ...
                    <path d="M293.15 220.457C296.397 220.457 299.03 217.743 299.03 214.394C299.03 211.046 296.397 208.331 293.15 208.331C289.902 208.331 287.269 211.046 287.269 214.394C287.269 217.743 289.902 220.457 293.15 220.457Z" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
